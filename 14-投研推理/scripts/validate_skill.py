...
LOCAL_REQUIRED_FILES = [
    "SKILL.md",
    "core_manifest.json",
    "references/A03_研报级输出说明.md",
    "schemas/投研推理输出结构.json",
    "examples/01_通用本体投资经理质询样例.json",
]
...
def assert_schema_and_examples():
    schema = load_json(ROOT / "schemas" / "投研推理输出结构.json")
    jsonschema.Draft202012Validator.check_schema(schema)
    load_json(ROOT / "examples" / "01_通用本体投资经理质询样例.json")
...
def main():
    ...
    print("OK: ontology reasoning skill validated")
